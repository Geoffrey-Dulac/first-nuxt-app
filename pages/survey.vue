<template>
  <div class="text-center">
    <div v-if="this.$store.state.step === 0">
      <h1>question 1</h1>
      <h3>{{ $store.state.round1.question }}</h3>
    ...
    <div v-if="this.$store.state.step === 1">
      ...
      <h1>question 2</h1>
      <h3>{{ $store.state.round2.question }}</h3>
    ...
    <div v-if="this.$store.state.step === 2">
      ...
      <h1 v-else class="red-bad-answer">Mauvaise réponse</h1>
      <h1>question 3</h1>
      <h3>{{ $store.state.round3.question }}</h3>
    ...
    <div v-if="this.$store.state.step === 3">
      ...
      <h1 v-else class="red-bad-answer">Mauvaise réponse</h1>
      <h1>question 4</h1>
      <h3>{{ $store.state.round4.question }}</h3>
    ...
    <div v-if="this.$store.state.step === 4">
      ...
      <h1 v-else class="red-bad-answer">Mauvaise réponse</h1>
      <h1>question 5</h1>
      <h3>{{ $store.state.round5.question }}</h3>
